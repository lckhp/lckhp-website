...
const DonateCategory: React.FC<DonateCategoryProps> = ({ category }) => {
  ...
  const getSEOParams = () => {
    if (category === "blood_bank") {
      ...
      return {
        title:
          "Non-Profit Organizations & Schools in Nepal | Donate to Educational NGOs",
        description:
          "Comprehensive directory of verified non-profit organizations, schools, and educational institutions in Nepal that need donations and support. Find trusted NGOs and educational centers in Kathmandu and Patan through Leo Club of Kathmandu Himalayas Patan.",
        keywords:
          "non-profit organizations nepal, donate to schools nepal, educational ngos kathmandu, support community organizations kathmandu, educational donations nepal, school supply donations, community support nepal, verified non-profits nepal, donate educational materials, rural education support, women empowerment organizations, youth development centers nepal",
  ...
  useEffect(() => {
    ...
    // Add FAQ structured data for organization category
    if (category === "organization") {
      const faqData = {
        ...
        mainEntity: [
          {
            "@type": "Question",
            name: "What types of organizations are listed here?",
            acceptedAnswer: {
              "@type": "Answer",
              text: "We list verified educational institutions, vocational training centers, community development organizations, and other non-profits working in Nepal that need material and resource support.",
            },
          },
          {
            "@type": "Question",
            name: "How can I donate to these organizations?",
            acceptedAnswer: {
              "@type": "Answer",
              text: "You can contact them directly using the information provided. Most organizations accept educational materials, books, stationery, computers, and other learning resources. Some may also accept monetary donations.",
            },
          },
          {
            "@type": "Question",
            name: "How does Leo Club verify these organizations?",
            acceptedAnswer: {
              "@type": "Answer",
              text: "Our team personally visits each organization to verify their existence, assess their needs, and ensure they are legitimate non-profits serving the community. We update our listings regularly to maintain accuracy.",
            },
          },
          {
            "@type": "Question",
            name: "What items are most needed by these organizations?",
            acceptedAnswer: {
              "@type": "Answer",
              text: "Educational materials like books, stationery, computers, scientific equipment, and sports gear are often in high demand. Specific needs vary by organization and are usually indicated in their profiles.",
            },
          },
        ],
      };
              ...
              <div className="mt-6 border-t pt-4 border-gray-200">
                ...
                <div className="mb-3">
                  <h4 className="font-medium text-gray-800">
                    What types of organizations are listed here?
                  </h4>
                  <p className="text-gray-600">
                    We list verified educational institutions, vocational
                    training centers, community development organizations, and
                    other non-profits working in Nepal that need material and
                    resource support.
                  </p>
                </div>
                ...
                <div className="mb-3">
                  ...
                  <p className="text-gray-600">
                    You can contact them directly using the information
                    provided. Most organizations accept educational materials,
                    books, stationery, computers, and other learning resources.
                    Some may also accept monetary donations.
                  </p>
                </div>

                <div className="mb-3">
                  <h4 className="font-medium text-gray-800">
                    How does Leo Club verify these organizations?
                  </h4>
                  <p className="text-gray-600">
                    Our team personally visits each organization to verify their
                    existence, assess their needs, and ensure they are
                    legitimate non-profits serving the community. We update our
                    listings regularly to maintain accuracy.
                  </p>
                </div>

                <div className="mb-3">
                  <h4 className="font-medium text-gray-800">
                    What items are most needed by these organizations?
                  </h4>
                  <p className="text-gray-600">
                    Educational materials like books, stationery, computers,
                    scientific equipment, and sports gear are often in high
                    demand. Specific needs vary by organization and are usually
