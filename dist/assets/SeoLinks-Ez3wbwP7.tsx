  ...
  return (
    <div className="sr-only" aria-hidden="true">
      ...
      <ul>
        ...
        <li>
          <a href="/projects/we-hear-your-outcry">
            Drug Awareness and Prevention in Kathmandu
          </a>
        </li>
        <li>
          <a href="/projects/we-hear-your-outcry">
            Addiction Support Services Nepal
          </a>
        </li>
        <li>
          <a href="/projects/we-hear-your-outcry">
        ...
        <li>
          <a href="/projects/uttam-shakti">
            Sustainable Livelihood Skills Development
          </a>
        </li>
        <li>
          <a href="/projects/uttam-shakti">
            Female Entrepreneurship Programs in Nepal
          </a>
        </li>
        <li>
          <a href="/projects">Leo Club KHP Community Impact Initiatives</a>
        </li>
      </ul>
