...
import ProjectsSeoLinks from "../components/ProjectsSeoLinks";
...
const Projects: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <SEO
        title="Community Projects in Nepal | Leo Club of Kathmandu Himalayas Patan"
        description="Explore impactful community projects by Leo Club of KHP including We Hear Your Outcry mental health initiative and Uttam Shakti women empowerment program in Nepal."
        keywords="leo club projects, community service nepal, youth volunteering projects, we hear your outcry, uttam shakti, menstrual health nepal, social impact projects kathmandu, youth-led initiatives nepal"
        url="/projects"
        type="CollectionPage"
        structuredData={[]}
      />
