...
const ProjectDetail: React.FC = () => {
  ...
  const projectsData: ProjectData[] = [
    {
      ...
      pdfImages: 15,
      keywords:
        "mental health awareness nepal, drug awareness kathmandu, youth support programs, community healing initiatives, leo club social awareness projects, addiction support nepal, youth mental health resources patan",
    },
    {
      id: "uttam-shakti",
      title: "Uttam Shakti",
      ...
      keywords:
        "women empowerment nepal, menstrual health education, sustainable livelihood training, pad making initiatives, skill development for women, entrepreneurship training nepal, rural women empowerment, sanitary pad production training",
    },
  ];
  ...
  const projectStructuredData = {
    ...
    image: project.imageUrl || "/placeholder-image.png",
    author: {
      "@type": "Organization",
    ...
    url: `https://lckhp.org/projects/${project.id}`,
    mainEntityOfPage: {
      "@type": "WebPage",
      "@id": `https://lckhp.org/projects/${project.id}`,
    },
    articleBody: project.fullDescription.join(" "),
  };
  ...
  const breadcrumbStructuredData = {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        position: 3,
        name: project.title,
        item: `https://lckhp.org/projects/${project.id}`,
      },
    ],
  };
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <SEO
        title={`${project.title} | Leo Club of Kathmandu Himalayas Patan`}
        description={`${project.description}. Learn more about this impactful community initiative by Leo Club of Kathmandu Himalayas Patan.`}
        keywords={
          project.keywords ||
          "leo club projects, community service nepal, youth volunteering projects"
        }
        image={project.imageUrl || "/placeholder-image.png"}
