...
const CertificateView = () => {
  ...
  if (!uuid || !certificate) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-b from-gray-900 to-gray-800 text-white text-center px-4">
        <motion.div
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 py-12 px-4 relative overflow-hidden">
      ...
      >
          ...
          >
            ...
            <div className="border-t border-gray-200 mt-6 pt-6">
              <p className="text-gray-700 italic">
                ...
                been recognized for their participation and contribution to the
        ...
        >
          <p>
            © {new Date().getFullYear()} Leo Club of Kathmandu Himalayas Patan.
            All rights reserved.
          </p>
          <p className="mt-1">
            This certificate can be verified by the QR code or the URL provided.
          </p>
        </motion.div>
      </motion.div>
    </div>
